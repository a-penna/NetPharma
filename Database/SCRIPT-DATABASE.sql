...
insert into prodotto(id, nome, marchio, produttore, formato, descrizione, disponibilita, prezzo, categoria) values(1003, "Siria 20 Mascherina FFP2 Taglia Small Nera 1 Pezzo", "Siria", "Siria italia srl", "Mascherina", "La mascherina filtrante Siria 20 Small FFP2 NR, per i più piccoli, offre un'efficace protezione delle vie respiratorie da particelle solide e/o liquide non volatili (polveri, fumi, nebbie). Il ferretto stringinaso è in grado di assicurare un'ottima adattabilità ad ogni tipo di volto.", 1000, '1.99', 3);
