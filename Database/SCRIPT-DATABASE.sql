...
insert into prodotto(id, nome, marchio, produttore, formato, descrizione, disponibilita, prezzo) values(883, "Salvelox Protettore Alluce", "Salvelox", "E.F.A.S S.P.A.", "Protettore Alluce", "La protezione in tessuto elastico per l\'alluce valgo � dotata di un cusinetto interno di gel. Riduce il dolore della protuberanza ossea, evitando lo sfregamento sull\'alluce valgo.", 200, '8.60');
insert into carrello(cliente, prodotto, quantita) values("Mrossi", 883, 2);
insert into prodotto(id, nome, marchio, produttore, formato, descrizione, disponibilita, prezzo) values(884, "Tantum Verde Gola", "Tantum Verde", "Angelini S.R.L.", "Spray Gola", "Tantum Verde Gola � usato come trattamento sintomatico di stati irritativo-infiammatori, anche associati a dolore del cavo orofaringeo, ad esempio faringiti.", 100, '5.50');
...
insert into prodotto(id, nome, marchio, produttore, formato, descrizione, disponibilita, prezzo, categoria) values(890, "Chicco Biberon Natural Feeling +2m Boy 250 ml", "Chicco", "Artsana", "Biberon", "Il silicone effetto mamma, la morbidezza e la flessibilit� della tettarella aiutano a riprodurre la suzione naturale e facilitano l\'alternanza tra seno e biberon. Ideale per i bambini nei primi mesi di vita, quando iniziano a succhiare con pi� voracit�. Biberon da 250 ml.", 50, '19.99', 1);
insert into prodotto(id, nome, marchio, produttore, formato, descrizione, disponibilita, prezzo, categoria) values(893, "Hipp Biologico Omogeneizzato Merenda Mela e Yogurt 125 g", "Hipp", "Hipp italia srl", "Barattolo", "Hipp Biologico Omogeneizzato al gusto di Mela e Yogurt � la merenda perfetta per i tuoi bambini. Indicato dal quinto mese compiuto.", 200, '4.99', 1);
...
insert into prodotto(id, nome, marchio, produttore, formato, descrizione, disponibilita, prezzo, categoria) values(920, "Chicco Gommotto PhysioForma Silicone Bimba 16-36 Mesi 2 Pezzi", "Chicco", "Artsana", "2 pezzi", "Il Gommotto PhysioForma della chicco per bimba � al 100% in silicone ed � stato pensato per dare sollievo ai pi� piccoli, rispettando la naturale crescita del cavo orale. Indicato dai 16 ai 36 mesi.", 100, '9.99', 1);
insert into prodotto(id, nome, marchio, produttore, formato, descrizione, disponibilita, prezzo, categoria) values(921, "Curasept Biosmalto Junior Dentifricio 75 ml", "Curasept", "Curasept s.p.a.", "Tubetto", "Curasept Biosmalto Junior � un dentifricio pensato per ragazzi dai 7 ai 12 anni che inibisce la formazione della placca nei denti da latte e permanenti.", 300, '2.99', 1);
...
insert into prodotto(id, nome, marchio, produttore, formato, descrizione, disponibilita, prezzo, categoria) values(1003, "Siria 20 Mascherina FFP2 Taglia Small Nera 1 Pezzo", "Siria", "Siria italia srl", "Mascherina", "La mascherina filtrante Siria 20 Small FFP2 NR, per i pi� piccoli, offre un'efficace protezione delle vie respiratorie da particelle solide o liquide non volatili (polveri, fumi, nebbie). Il ferretto stringinaso � in grado di assicurare un'ottima adattabilit� ad ogni tipo di volto.", 1000, '1.99', 3);
