...
insert into prodotto(id, nome, marchio, produttore, formato, descrizione, disponibilita, prezzo) values(883, "Salvelox Protettore Alluce", "Salvelox", "E.F.A.S S.P.A.", "Protettore Alluce", "La protezione in tessuto elastico per l'alluce valgo é dotata di un cusinetto interno di gel. Riduce il dolore della protuberanza ossea, evitando lo sfregamento sull'alluce valgo.", 200, '8.60');
...
insert into prodotto(id, nome, marchio, produttore, formato, descrizione, disponibilita, prezzo, categoria) values(885, "Pampers Salviette Sensitive Aloe 63 Pezzi", "Pampers sensitive", "Pampers", "Salviette", "Sensitive Salviettine con estratti naturali ideali per le pelli piÃ¹ sensibili, per il cambio e la pulizia di viso e mani. Il tessuto morbido e soffice garantisce la massima delicatezza sulla pelle. La lozione aiuta ad idratare e proteggere la pelle dalle irritazioni, ripristinando e mantenendo il pH al suo livello naturale. Senza profumo, senza alcool. Dermatologicamente testate.", 100, '3.99', 1);
insert into prodotto(id, nome, marchio, produttore, formato, descrizione, disponibilita, prezzo, categoria) values(890, "Chicco Biberon Natural Feeling +2m Boy 250 ml", "Chicco", "Artsana", "Biberon", "Il silicone effetto mamma, la morbidezza e la flessibilità della tettarella aiutano a riprodurre la suzione naturale e facilitano l'alternanza tra seno e biberon. Ideale per i bambini nei primi mesi di vita, quando iniziano a succhiare con più voracità. Biberon da 250 ml.", 50, '19.99', 1);
insert into prodotto(id, nome, marchio, produttore, formato, descrizione, disponibilita, prezzo, categoria) values(890, "Hipp Biologico Omogeneizzato Merenda Mela e Yogurt 2 x125 g", "Hipp", "Hipp italia srl", "Barattolo", "Hipp Biologico Omogeneizzato al gusto di Mela e Yogurt è la merenda perfetta per i tuoi bambini. Indicato dal 5° mese compiuto.", 200, '4.99', 1);
...
insert into prodotto(id, nome, marchio, produttore, formato, descrizione, disponibilita, prezzo, categoria) values(920, "Chicco Gommotto PhysioForma Silicone Bimba 16-36 Mesi 2 Pezzi", "Chicco", "Artsana", "2 pezzi", "Il Gommotto PhysioForma della chicco per bimba è al 100% in silicone ed è stato pensato per dare sollievo ai più piccoli, rispettando la naturale crescita del cavo orale. Indicato dai 16 ai 36 mesi.", 100, '9.99', 1);
insert into prodotto(id, nome, marchio, produttore, formato, descrizione, disponibilita, prezzo, categoria) values(921, "Curasept Biosmalto Junior Dentifricio 75 ml", "Curasept", "Curasept s.p.a.", "Tubetto", "Curasept Biosmalto Junior è un dentifricio pensato per ragazzi dai 7 ai 12 anni che inibisce la formazione della placca nei denti da latte e permanenti.", 300, '2.99', 1);
insert into categoria(nome) values ("Raffreddore");
insert into prodotto(id, nome, marchio, produttore, formato, descrizione, disponibilita, prezzo, categoria) values(885, "Vicks Vaporub Unguento Inalatorio 100g", "Vicks", "Procter Gamble", "Barattolo", "Vicks Vaporub Unguento si usa nel trattamento balsamico nelle affezioni delle prime vie respiratorie.", 82, '4.99', 2);
insert into prodotto(id, nome, marchio, produttore, formato, descrizione, disponibilita, prezzo, categoria) values(890, "Rinazina Spray Nasale Decongestionante", "Rinazina", "gsk", "Bottiglia", "Spray decongestionante ad azione rapida e prolungata che libera il naso anche in caso di sinusite.", 50, '5.99', 2);
insert into prodotto(id, nome, marchio, produttore, formato, descrizione, disponibilita, prezzo, categoria) values(890, "Vivin C 330 mg Acido Acetilsalicilico + 200 mg Acido Ascorbico (Vit. C) 20 Compresse Effervescenti", "Vivin C", "Menarini", "Compresse Effervescenti", "Con Vivin C puoi stare alla larga dagli eccì in tutti i periodi dell’anno. Vivin C grazie alla combinazione di Acido Acetilsalicilico e Vitamina C, è indicato contro le sintomatologie dell’influenza e del raffreddamento, supportando il sistema immunitario", 1000, '8.79', 2);
insert into categoria(nome) values ("Protezione Antivirale");
insert into prodotto(id, nome, marchio, produttore, formato, descrizione, disponibilita, prezzo, categoria) values(885, "Medel Pulsossimetro Pulse", "Medel", "Medel International", "Pulsossimetro", "Medel Pulse è il pulsossimetro in grado di calcolare la saturazione dell’ossigeno (SpO2) e la frequenza cardiaca (pulsazioni).", 20, '10.50', 3);
insert into prodotto(id, nome, marchio, produttore, formato, descrizione, disponibilita, prezzo, categoria) values(890, "Amuchina Gel X Germ Disinfettante Mani 80 ml", "Amuchina", "Amuchina", "Flacone", "Gel disinfettante mani, specificatamente studiato per igienizzare e pulire a fondo la pelle. E' utile in situazioni in cui non si dispone di acqua e sapone.", 70, '30.00', 3);
insert into prodotto(id, nome, marchio, produttore, formato, descrizione, disponibilita, prezzo, categoria) values(890, "Siria 20 Mascherina FFP2 Taglia Small Nera 1 Pezzo", "Siria", "Siria italia srl", "Mascherina", "La mascherina filtrante Siria 20 Small FFP2 NR, per i più piccoli, offre un'efficace protezione delle vie respiratorie da particelle solide e/o liquide non volatili (polveri, fumi, nebbie). Il ferretto stringinaso è in grado di assicurare un'ottima adattabilità ad ogni tipo di volto.", 1000, '1.99', 3);
